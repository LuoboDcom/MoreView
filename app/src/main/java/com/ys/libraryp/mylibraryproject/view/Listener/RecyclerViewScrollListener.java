package com.ys.libraryp.mylibraryproject.view.Listener;
...
public class RecyclerViewScrollListener implements OnScrollListener {
     ...
     */
    public RecyclerViewScrollListener(ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
