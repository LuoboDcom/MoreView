...
import com.ys.libraryp.mylibraryproject.view.HoveringScrollView.HoveringScrollView;
...
public class TwoFragment extends Fragment {
    ...
    private void initView() {
        fragment_one = (TextView) view.findViewById(R.id.fragment_two);
        fragment_one.setText("fragment=========222222");
        fragment_one.setTextColor(getResources().getColor(android.R.color.holo_orange_dark));

        hoveringScrollView = (HoveringScrollView) view.findViewById(R.id.view_hover);
        hoveringScrollView.setTopView(R.id.top);
    }
